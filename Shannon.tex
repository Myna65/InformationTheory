...
\paragraph{Passage aux probabilités composées}
	...
	\paragraph{}
	Rappelons quand même la définition de $\alpha_i \times \beta_i$, cela dénote la probabilité d'avoir à la fois l'élément $\alpha_i$ et l'élément $\beta_i$ c'est-à-dire que :
	\begin{enumerate}
...
\paragraph{Formulation de la probabilité d'erreur}
...
\paragraph{Calcul de la probabilité d'erreur}
	...
	\paragraph{}
	Rappelons la seconde inégalité de Feinstein (voir \ref{second_inequality}) : \newline
	...
	\paragraph{}
	La première condition est remplie vu le choix des $B_i$ et nous venons de prouver la seconde juste avant. Nous pouvons donc en conclure que
	
	\[P\le \lambda\]
	
	\paragraph{}La probabilité d'erreur lors du transfert dans le canal peut donc être réduite autant que désiré grâce au choix de l'encodage.
