...
\subsection{Le codage}
	...
	créer un alphabet qui minimise la longueur moyenne'une lettre ; 
...
\subsection*{Théorème}
	...
	Et que, si cette séquence était transmise à travers le canal donné, alors
...
\subsection*{Remarque}
	...
	seule séquence $u_0$ donc à partir d'ici il est impossible de retrouver 
	précisément quelle séquence a été transmisse et la probabilité
	d'erreur sur ces séquences est donc égale à 1. Néanmoins vu que ce nombre 
	de séquence peut être rendu très faible, cela n'est pas en 
